...
| [technical-director](plugins/technical-director/) | Technical direction across the development lifecycle: diagnosis, domain modeling, planning, PRDs, issue triage, TDD, codebase design and architecture, prototyping, implementation, and repo-tooling guardrails. 22 skills across engineering, productivity, and misc buckets. |
