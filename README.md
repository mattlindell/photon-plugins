...
| [ph-build](plugins/ph-build/) | **Unattended implementation** — building what was decided, at a cost that tracks what is still unknown. Forked from pstack: reads the rigor signal, gates expensive multi-agent work behind one-way doors, caps every fan-out. 34 skills, 23 principles, 18 playbooks, 3 agents. Requires `ph-lib`. |
