...
TEMPLATES = {
    "academic": {
        ...
        "sections": [
            ...
            (
                "Methodology",
                "[Study design, sample size, data sources, analytical approach]",
            ),
            (
                "Key Findings",
            ...
            (
                ...
                "[Key p-values, effect sizes, confidence intervals]",
            ),
            (
                "Limitations",
                "- [Limitation 1: scope, sample, methodology gap]\n- [Limitation 2]",
            ),
            (
                "Implications",
            ...
            (
                "Quality Assessment",
                "Credibility: [High/Med/Low] | Evidence: [High/Med/Low] | Recency: [High/Med/Low] | Objectivity: [High/Med/Low]",
            ),
        ],
    },
    "article": {
        ...
        "sections": [
            ...
            (
                "Bias Check",
                "Author affiliation: [?] | Funding: [?] | Balanced perspective: [Yes/No]",
            ),
            (
    ...
    "report": {
        ...
        "sections": [
            ...
            (
                "Relevance",
                "[Why this matters for our context — specific applicability]",
            ),
            (
                "Quality Assessment",
                "Credibility: [High/Med/Low] | Evidence: [High/Med/Low] | Recency: [High/Med/Low] | Objectivity: [High/Med/Low]",
    ...
    "executive": {
        ...
        "sections": [
            ...
            (
                "Confidence",
                "[High/Medium/Low] — based on source quality and evidence strength",
            ),
        ],
    },
    "comparison": {
        ...
        "sections": [
            ...
            (
                "Synthesis",
                "[Weight-of-evidence recommendation: what to believe and do]",
            ),
        ],
    },
    "literature": {
        ...
        "sections": [
            ...
            (
                "Search Scope",
                "[Databases, keywords, date range, inclusion/exclusion criteria]",
            ),
            ...
            (
                "Gaps in Literature",
                "- [Under-researched area 1]\n- [Under-researched area 2]",
            ),
            (
                "Synthesis",
                "[Overall state of knowledge — what we know, what we don't, where to go next]",
            ),
        ],
    },
}
...
LENGTH_CONFIGS = {
    ...
    "detailed": {
        "max_sections": 99,
        "label": "Detailed (full template with extended guidance)",
    },
}
