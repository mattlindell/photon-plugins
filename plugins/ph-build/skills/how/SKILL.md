...
- `model`: your configured how-explorer model (default in [Fan-out](#fan-out))
- `readonly`: `true`
...
- `subagent_type`: `general-purpose`
- `model`: your configured how-explainer model (default in [Fan-out](#fan-out))
- `readonly`: `true`
...
| --- | --- | --- |
| Explorers | `scan` | 3 |
| Explainer | `judgment` | 1 |

Simple questions take no explorers at all — one explainer reads and answers in a
single pass. Spawn explorers only when the question genuinely spans subsystems.
