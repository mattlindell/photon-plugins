---
name: automate-me
description: Draft or revise a personal -mode skill that captures how you work, optionally pulling evidence from recent transcripts.
...
The **writing-for-agents** skill sets the shape and granularity. Read it before drafting. Don't copy rules from any existing mode skill; the user's rules are their own.
