...
- `ph-pm/references/atlassian-mcp-tools.md` — the canonical MCP tool list; consult it before naming any
...
time. Never invent a tool name — if a capability is absent from `ph-pm/references/atlassian-mcp-tools.md`,
