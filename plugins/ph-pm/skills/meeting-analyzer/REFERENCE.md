...
| Skill                               | Relationship                                                     |
| ----------------------------------- | ---------------------------------------------------------------- |
| `ph-pm/senior-pm`         | Broader PM scope — use for project planning, risk, stakeholders  |
| `ph-pm/scrum-master`      | Agile ceremonies — pairs with meeting-analyzer for retro quality |
| `ph-pm/confluence-expert` | Store meeting analysis outputs as Confluence pages               |
