...
| Skill                               | Relationship                                                 |
| ----------------------------------- | ------------------------------------------------------------ |
| `ph-pm/senior-pm`         | Broader PM scope — status reports feed into PM reporting     |
| `ph-pm/meeting-analyzer`  | Meeting insights can feed into 3P updates and status reports |
| `ph-pm/confluence-expert` | Publish comms as Confluence pages for permanent record       |
