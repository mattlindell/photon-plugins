...
- [ ] The meeting has a single primary output (decision / plan / commitments).
- [ ] Attendees are the minimum set needed to discuss and act.

## B) Pre-meeting checklist (setup + priming)
...
- [ ] Keep discussion anchored to the decision/output.
- [ ] Capture decisions/actions live in the notes template.
- [ ] Use timeboxes; call out when a topic is drifting.
- [ ] If conflict stalls progress, summarize trade-offs and ask decision owner to choose a path.

## D) Close-out checklist (prevent re-meetings)
- [ ] What did we decide? (written)
- [ ] Who does what by when? (owners + due dates)
- [ ] Who else needs to know? (named + assigned)
- [ ] Any open questions are recorded with an owner and a plan to resolve.
