...
```md
# Uncertainty Planning Pack — <project / initiative>
...
| Phase | Goal | Output(s) | Learning gate (what must be true) | Notes |
|---|---|---|---|---|
...
- If <signal> crosses <threshold>, then we will <rollback/pivot/escalate> by <when>.

## 6) Cadence + comms
Learning/decision cadence:
- Wartime (default if crisis): daily/48-hour review for top hypotheses
- Peacetime: weekly learning review; biweekly decision checkpoint

Learning review agenda:
1) What changed since last review?
2) What did we learn (hypothesis results)?
3) What decisions do we make now (stop/pivot/scale)?
4) What are the next experiments?
