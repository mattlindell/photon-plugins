...
## 1) Clarity of scope and safety
1: Goal unclear; blame framing; roles missing  
3: Goal and roles exist; mostly blameless; some ambiguity  
5: Goal and audience are crisp; explicit blameless norms; roles and constraints are clear

## 2) Evidence and timeline quality
1: Hand-wavy story; no timestamps or sources  
3: Partial timeline; some evidence; facts/hypotheses mixed  
5: Clear timeline with timestamps and links; facts vs hypotheses explicitly separated
...
3: Some actions with owners; weak success signals  
5: Concrete decisions; action tracker with owners, due dates, success signals, and follow-up cadence
