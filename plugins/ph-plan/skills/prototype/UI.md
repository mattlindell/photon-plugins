...
The full set of variants is the primary source, so it lands on the throwaway branch, not the garbage — variant components and the switcher left in the main branch rot fast and confuse the next reader.
