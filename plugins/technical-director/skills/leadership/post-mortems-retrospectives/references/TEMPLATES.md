...
- **Title:** <short name>
- **Date/time:** <YYYY-MM-DD> (timebox: <60/90 min>)
- **Facilitator:** <name/role>
- **Scribe:** <name/role>
- **Decision owner:** <name/role>
- **Attendees:** <list>
- **Audience for write-up:** Team / Leadership / Company
- **Goal:** <learning / prevention / recovery / alignment>
...
- **Learning:** <we learned that…>
  - **Evidence:** <links/metrics>
  - **Implication:** <what changes because of this?>

### Decisions (with tradeoffs)
- **Decision:** <what we will change>
  - **Why:** <link to learning/factor>
  - **Tradeoffs:** <what we give up>
  - **Owner:** <name/role>

## 5) Action tracker (required)

| Action | Type (fix/guardrail/process/etc) | Owner | Due date | Success signal | Follow-up date | Notes |
|---|---|---|---|---|---|---|
| <action> | <type> | <owner> | <YYYY-MM-DD> | <metric/observable> | <YYYY-MM-DD> | <notes> |

## 6) Kill criteria / triggers (optional but recommended)

| Signal (observable) | Window | Trigger threshold | Committed action | Owner | Evidence source |
|---|---|---|---|---|---|
| <metric> | <time> | <threshold> | <pause/pivot/kill/escalate> | <owner> | <dashboard/link> |

## 7) Dissemination plan (required for leadership contexts)
