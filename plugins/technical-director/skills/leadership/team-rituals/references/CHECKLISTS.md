...
- [ ] Golden Ritual list is small (3–7), and each ritual has a crisp purpose
- [ ] Every ritual is **Named** (people can reference it in conversation)
- [ ] Every ritual is **Templated** (agenda/notes format exists and is easy to reuse)
- [ ] Rituals are **Known by first Friday** (onboarding primer exists and is discoverable)
...
- [ ] Agenda is timeboxed and includes required prework
- [ ] Outputs are explicit (what gets written, where it lives, and who follows up)
- [ ] Decision rules are clear (who decides, how to escalate)
- [ ] Anti-patterns are listed with fixes
- [ ] Async fallback exists (how non-attendees participate and stay informed)
...
- [ ] A quarterly ritual review is scheduled with a keep/change/kill decision rule
- [ ] Feedback loop exists (monthly pulse or equivalent)
- [ ] Retirement path exists (how rituals get removed without confusion)
