...
## B) Stakeholders + decision rights (required)
4) Who is the **Decider** (or decision body)? Who can veto?
5) Who are the top 3–7 stakeholders to influence (roles/names), and what functions do they represent (Eng, Design, Sales, Support, Legal/Compliance, Finance, Security, etc.)?
...
10) Any compliance, security, privacy, legal, or monetization constraints to respect?
11) What tradeoff are we making (speed vs quality, growth vs risk, scope vs timeline)?

## E) Current alignment state (recommended)
12) What has already been discussed, and where does alignment break down?
13) What objections have you already heard (verbatim if possible)?
14) Which stakeholders must not be surprised in the live meeting?

## F) Artifacts + cadence (optional)
15) Should the primary artifact be a **memo/pre-read** or a **deck** (or both)?
16) What is the expected cadence: async pre-read, 1:1 pre-briefs, then decision meeting?
...
- Artifact: 1-page Alignment Brief + stakeholder map + meeting plan + follow-up comms
